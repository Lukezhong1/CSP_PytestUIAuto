...
from PageObjects.reportFuncSetupPage import Report_FuncSetupPage
...
def ini_pages(driver):
    ...
    Report_FuncSetup_Page = Report_FuncSetupPage(driver)
    yield driver, login_page, scalebar_page,Report_FuncSetup_Page
...
@pytest.fixture(scope='class')
def login(ini_pages):
    driver, login_page, scalebar_page,Report_FuncSetup_Page = ini_pages
    login_page.open_url()
    login_page.login(username, password)
    yield login_page, scalebar_page,Report_FuncSetup_Page
    driver.delete_all_cookies()
