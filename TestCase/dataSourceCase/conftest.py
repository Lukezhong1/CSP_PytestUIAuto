...
from PageObjects.dataSourceMgmtPage import DataSourceMgmtPage
...
def ini_pages(driver):
    ...
    data_source_page =DataSourceMgmtPage(driver)
    yield driver, login_page, scalebar_page,data_source_page
...
@pytest.fixture(scope='class')
def login(ini_pages):
    driver, login_page, scalebar_page,data_source_page = ini_pages
    login_page.open_url()
    login_page.login(username, password)
    yield login_page, scalebar_page,data_source_page
    driver.delete_all_cookies()
