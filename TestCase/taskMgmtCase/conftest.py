...
from PageObjects.taskMgmtPage import TaskMgmtPage
...
def ini_pages(driver):
    ...
    taskmgmt_page = TaskMgmtPage(driver)
    yield driver, login_page, scalebar_page,taskmgmt_page
...
@pytest.fixture(scope='class')
def login(ini_pages):
    driver, login_page, scalebar_page,taskmgmt_page = ini_pages
    login_page.open_url()
    login_page.login(username, password)
    yield login_page, scalebar_page,taskmgmt_page
    driver.delete_all_cookies()
