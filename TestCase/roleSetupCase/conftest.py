...
from PageObjects.roleSetupPage import RoleSetupPage
...
def ini_pages(driver):
    ...
    rolesetup_page = RoleSetupPage(driver)
    yield driver, login_page, scalebar_page,rolesetup_page
...
@pytest.fixture(scope='class')
def login(ini_pages):
    driver, login_page, scalebar_page,rolesetup_page = ini_pages
    login_page.open_url()
    login_page.login(username, password)
    yield login_page, scalebar_page,rolesetup_page
    driver.delete_all_cookies()
