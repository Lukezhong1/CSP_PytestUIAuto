...
from PageObjects.udcSetupPage import UDCSetupPage
...
def ini_pages(driver):
    ...
    udcsetup_page = UDCSetupPage(driver)
    yield driver, login_page, scalebar_page,udcsetup_page
...
@pytest.fixture(scope='class')
def login(ini_pages):
    driver, login_page, scalebar_page,udcsetup_page = ini_pages
    login_page.open_url()
    login_page.login(username, password)
    yield login_page, scalebar_page,udcsetup_page
    driver.delete_all_cookies()
