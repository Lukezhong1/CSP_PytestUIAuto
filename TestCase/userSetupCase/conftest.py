...
from PageObjects.userSetupPage import UserSetupPage
...
def ini_pages(driver):
    ...
    usersetup_page = UserSetupPage(driver)
    yield driver, login_page, scalebar_page,usersetup_page
...
@pytest.fixture(scope='class')
def login(ini_pages):
    driver, login_page, scalebar_page,usersetup_page = ini_pages
    login_page.open_url()
    login_page.login(username, password)
    yield login_page, scalebar_page,usersetup_page
    driver.delete_all_cookies()
